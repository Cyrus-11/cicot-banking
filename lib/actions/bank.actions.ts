...
export const getAccount = async ({ appwriteItemId }: getAccountProps) => {
  try {
    ...
    if (error instanceof Error) {
      ...
      console.error("An unknown error occurred while getting the account:", error);
    }
  }
};
...
export const getTransactions = async ({
    ...
    try {
      ...
      while (hasMore) {
        ...
        console.log("Requesting transactions with:", {
          accessToken,
        });
      ...
      if (error instanceof Error) {
        ...
        console.error(
          "An unknown error occurred while getting the transactions:",
          error
        );
      }
    }
